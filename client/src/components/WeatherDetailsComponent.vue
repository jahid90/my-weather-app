  ...
  methods: {
    async handleLocationChange ({ location }) {
      try {
        ...
        // Pass env var to client js app
        // window.env = window.env || {};
        // window.env.SERVICE_ENDPOINT = 'https://weather.jahiduls.mint/api';
        const serviceEndpoint = (window.env && window.env.SERVICE_ENDPOINT) || 'http://localhost:3000/weather';
